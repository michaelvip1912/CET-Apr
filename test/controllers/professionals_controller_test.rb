...
class ProfessionalsControllerTest < ActionController::TestCase
  ...
  test "should create professional" do
    assert_difference('Professional.count') do
      post :create, professional: { professional_encode: @professional.professional_encode, professional_name: @professional.professional_name }
    end
  ...
  test "should update professional" do
    patch :update, id: @professional, professional: { professional_encode: @professional.professional_encode, professional_name: @professional.professional_name }
    assert_redirected_to professional_path(assigns(:professional))
  end
